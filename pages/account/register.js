                ...
                <div className="container mx-auto">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Link className="navbar-brand" href="/#">
                            <img src="/icon/codashop-logo.png" width={200} height={50}/>
                        </Link>
                    </div>
                    <h2 className="text-4xl fw-bold color-palette-1 mb-10">Register</h2>
                    <p className="text-lg color-palette-1 m-0">Register Now And Join The CodaShop</p>
                        <div className="pt-40">
                        <label id="name" className="form-label text-lg fw-medium color-palette-1 mb-10">Full Name</label>
                            <input name="name" type="text" {...register("name")} className={`form-control rounded-pill text-lg ${errors.name ? "is-invalid" : ""}`} aria-describedby="name" placeholder="Write your name"/>
                        ...
                        <div className="button-group d-flex flex-column mx-auto pt-50">
                            ...
                            <div className="w-full">
                                <p className="text-center text-dark">
                                    Already have an account at CashLess Shop?{" "}
                                    <Link href="/account/login" role="button" style={{textDecoration:"none", color:"#2b0433"}}>
