                    ...
                    <div className="col-xxl-6 col-lg-6 my-auto py-lg-0 pt-lg-50 pb-lg-50 pt-30 pb-47 px-0">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="container mx-auto">
                                ...
                                <p className="text-lg color-palette-1 m-0">Already Have an Account? Login Below</p>
                                ...
                                <div className="button-group d-flex flex-column mx-auto pt-30 pb-30">
                                    ...
                                    <div className="w-full">
                                        ...
                                        Don't have an account yet?{" "}
                                            <Link href="/account/register" role="button" style={{textDecoration:"none", color:"#2b0433"}}>
                                                <span className="font-semibold cursor-pointer !text-[#f0fc54]">Register</span>
                                            </Link>
                                        </p>
                                    </div>
                                </div>
